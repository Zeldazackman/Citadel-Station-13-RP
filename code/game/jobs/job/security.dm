...
/datum/job/detective
	...
	alt_titles = list("Forensic Technician" = /datum/alt_title/detective/forensic_tech, "Crime Scene Investigator" = /datum/alt_title/detective/csi)
...
/datum/alt_title/securiy_officer/junior
